...
<div class="main">
    <div class="container a-container" id="a-container">
        <form class="form" id="a-form" method="post" action="register">
            ...
            <span class="error1">${fromBean.errors.username}</span>
            <span class="error1">${reError}</span>
            <input class="form__input" type="password" id="password" name="password" value="${fromBean.password}" placeholder="密码" required>
            <span class="error2">${fromBean.errors.password}</span>
            ...
            <span class="error3">${fromBean.errors.confirmPassword}</span>
